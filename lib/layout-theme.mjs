...
export const LAYOUT_THEMES = deepFreeze({
  ...
  // Red and gold on warm cream. Unfinished layout: see productionReady in layout-registry.mjs.
  chinese: {
    gallery: {
      sectionBg: "bg-[#F8EBD9]",
      title: "text-red-900",
    ...
    seasonal: {
      sectionBg: "bg-gradient-to-br from-red-50 via-[#FDF6EC] to-amber-50",
      card: "bg-white",
      text: "text-red-950",
      badge: "bg-red-800 text-amber-100",
    },
    reviews: {
      sectionBg: "bg-[#FDF6EC]",
      card: "bg-white border-amber-300",
      text: "text-red-950",
      dotActive: "bg-red-800",
      dotInactive: "bg-amber-200",
      arrow: "bg-white border-amber-300 text-red-900 hover:bg-red-50",
    },
    appointment: {
      sectionBg: "bg-white",
      card: "bg-[#FDF6EC] border-amber-300",
      text: "text-red-950",
      input: "bg-white border-amber-300 focus:border-red-700 focus:ring-2 focus:ring-red-700/20",
    ...
    events: {
      ...
      card: "bg-white border-amber-300",
      text: "text-red-950",
      dateBadge: "bg-red-800 text-amber-100",
    },
    share: {
      button: "bg-white border-amber-300 text-red-900 hover:bg-red-50",
    },
    related: {
      section: "bg-[#F8EBD9] border-amber-300",
      title: "text-red-950",
      viewAll: "text-red-800",
      viewAllHover: "hover:text-red-950",
      cardBg: "bg-white",
      cardBorder: "border-amber-200",
      cuisineTagBorder: "border-amber-300",
      cuisineTagBg: "bg-white",
      cuisineTagText: "text-red-900",
      areaTagBg: "bg-red-800/10",
      areaTagText: "text-red-800",
      hoursText: "text-stone-600",
      viewMenu: "text-red-800",
      viewMenuHover: "group-hover:text-red-950",
      closedBadge: "bg-stone-800/80 text-stone-100",
    },
  },
  // Emerald and songket gold on off-white. Unfinished layout: see productionReady in layout-registry.mjs.
  malay: {
    gallery: {
      sectionBg: "bg-[#ECF1E8]",
    ...
    seasonal: {
      sectionBg: "bg-gradient-to-br from-white via-white to-emerald-50",
      card: "bg-white",
      text: "text-[#0A1F17]",
      badge: "bg-emerald-800 text-amber-100",
    },
    reviews: {
      sectionBg: "bg-[#F8F6EF]",
      ...
      arrow: "bg-white border-emerald-200 text-emerald-900 hover:bg-emerald-50",
    },
    appointment: {
      sectionBg: "bg-white",
      card: "bg-[#F8F6EF] border-emerald-200",
      text: "text-[#0A1F17]",
      input: "bg-white border-emerald-200 focus:border-emerald-600 focus:ring-2 focus:ring-emerald-600/20",
      buttonPrimary: "bg-emerald-800 hover:bg-emerald-900",
      successIcon: "text-emerald-600",
    },
    events: {
      sectionBg: "bg-[#F8F6EF]",
      card: "bg-white border-emerald-200",
      text: "text-[#0A1F17]",
      dateBadge: "bg-emerald-800 text-amber-100",
    },
    share: {
      button: "bg-white border-emerald-200 text-emerald-900 hover:bg-emerald-50",
    },
    related: {
      section: "bg-[#ECF1E8] border-emerald-200",
      title: "text-emerald-950",
      viewAll: "text-emerald-800",
      viewAllHover: "hover:text-emerald-950",
      cardBg: "bg-white",
      cardBorder: "border-emerald-100",
      cuisineTagBorder: "border-emerald-200",
      cuisineTagBg: "bg-white",
      cuisineTagText: "text-emerald-800",
      areaTagBg: "bg-amber-100",
      areaTagText: "text-amber-900",
      hoursText: "text-stone-600",
      viewMenu: "text-emerald-800",
      viewMenuHover: "group-hover:text-emerald-950",
      closedBadge: "bg-stone-800/80 text-stone-100",
    },
  },
});
