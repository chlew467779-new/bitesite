...
export default function MerchantStoriesPage() {
  ...
  async function uploadImage(file: File, gallery: boolean) {
    if (!token) return;
    setUploading(true); setMessage('Compressing and uploading…');
    try {
